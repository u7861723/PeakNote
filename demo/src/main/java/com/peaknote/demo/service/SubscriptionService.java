...
public class SubscriptionService {
    ...
    public void createEventSubscription(String userId) {
        try {
            ...
            String notificationUrl = "https://141c730e2194.ngrok-free.app/webhook/notification";
    ...
    public void createTranscriptSubscription(String meetingId) {
        try {
            ...
            String notificationUrl = "https://141c730e2194.ngrok-free.app/webhook/teams-transcript"; // ✅ 修改成你自己的回调地址
